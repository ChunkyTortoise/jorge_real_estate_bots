...
class ConversationModel(Base):
    ...
    mode: Mapped[Optional[str]] = mapped_column(String(50), nullable=True, index=True)
    mode_version: Mapped[int] = mapped_column(Integer, default=1)
    ...
    human_takeover: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
    bilingual_required: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
